...
weather_2012 = pd.read_csv(DATA_PATH, parse_dates=True, index_col="date_time")
weather_2012[:5]
...
# pl_weather_description.plot.bar(x="date_time", y="is_snowing")  # does not work bcs. data too big
sns.barplot(data=pl_weather_description.to_pandas(), x="date_time", y="is_snowing")
